    ...
    return (
        <div>
            <div className={linksStyle.contactICOS}>
                <IcoLink Href={"https://github.com/Griga81745"} ImageICO={github}/>
                <IcoLink Href={"mailto:gr_73@inbox.ru"} ImageICO={mail}/>
                <IcoLink Href={"https://t.me/FrontEnd_Dev_Griga"} ImageICO={telegram}/>
            </div>
        </div>
    );
}
